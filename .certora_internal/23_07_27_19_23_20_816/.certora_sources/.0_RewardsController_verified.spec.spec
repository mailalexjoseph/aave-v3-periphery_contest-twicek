...
///////////////// Properties ///////////////////////
    ...
    rule VerifyAccruedRewards() {
        ...
        address[] memory rewardsList, uint256[] memory unclaimedAmounts = getAllUserRewards(assets, user);

        address[] memory rewardsList, uint256[] memory claimedAmounts = claimAllRewards(assets, reward);
