...
///////////////// Properties ///////////////////////
    ...
    rule BetterRewardsAreUpdated() {
        ...
        // Claim rewards
        // uint128 accruedForUserBefore = getRewardAccruedForUser(e1, AToken, reward, e1.msg.sender);

        env e2;
        uint256 time2 = e2.block.timestamp;
        require e2.block.timestamp > e1.block.timestamp;
        require e1.block.timestamp <= max_uint32;
        require e2.block.timestamp <= max_uint32;
        uint128 rewardCount = getRewardsCountForAsset(e, AToken);
        require rewardCount > 0;

        claimAllRewards(e2, args);

        // uint128 accruedForUserAfter = getRewardAccruedForUser(e2, AToken, reward, e2.msg.sender);
        ...
        assert lastUpdateTimestampAfter == time2;
    }
