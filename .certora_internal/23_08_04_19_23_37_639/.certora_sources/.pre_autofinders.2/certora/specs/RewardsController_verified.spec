...
///////////////// Properties ///////////////////////
    ...
    rule rewardsAreUpdated() {
        ...
        mathint timeDelta = to_mathint(time) - to_mathint(lastUpdateTimestampBefore);
        require to_mathint(emissionPerSecondBefore) * timeDelta * to_mathint(assetUnit) >= to_mathint(totalSupply);
        // index is 0
