...
///////////////// Properties ///////////////////////
    ...
    rule BetterRewardsAreUpdated() {
        ...
        // Claim rewards
        uint128 accruedForUserBefore = getRewardAccruedForUser(e1, AToken, reward, e.msg.sender);
        ...
        uint128 accruedForUserAfter = getRewardAccruedForUser(e2, AToken, reward, e.msg.sender);
