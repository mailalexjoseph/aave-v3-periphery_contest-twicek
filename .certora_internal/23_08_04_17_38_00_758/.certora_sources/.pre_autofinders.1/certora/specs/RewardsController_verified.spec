...
///////////////// Properties ///////////////////////
    ...
    rule rewardsAreUpdated() {
        ...
        indexBefore, emissionPerSecond, lastUpdateTimestampBefore, distributionEndBefore = getRewardsData(e, AToken, reward);
        ...
        indexAfter, emissionPerSecond, lastUpdateTimestampAfter, distributionEndAfter = getRewardsData(e, AToken, reward);
