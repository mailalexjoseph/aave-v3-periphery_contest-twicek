...
///////////////// Properties ///////////////////////
    ...
    rule BetterRewardsAreUpdated() {
        ...
        address[] assets;
        // _rewardsList length is 1.
        address[] _rewardsList = getRewardsList(e2);
        require _rewardsList.length == 1;


        indexBefore, emissionPerSecondBefore, lastUpdateTimestampBefore, distributionEndBefore = getRewardsData(e2, AToken, reward);
