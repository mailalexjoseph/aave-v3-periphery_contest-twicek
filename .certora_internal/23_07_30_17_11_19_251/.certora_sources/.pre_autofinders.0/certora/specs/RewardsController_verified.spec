...
///////////////// Properties ///////////////////////
    ...
    rule rewardsAreUpdated() {
        ...
        index, emissionPerSecond, lastUpdateTimestampBefore, distributionEnd = getRewardsData(e, asset, reward);

        claimAllRewards(e, assets, user);

        index, emissionPerSecond, lastUpdateTimestampAfter, distributionEnd = getRewardsData(e, asset, reward);

        assert lastUpdateTimestampBefore >= lastUpdateTimestampAfter;
