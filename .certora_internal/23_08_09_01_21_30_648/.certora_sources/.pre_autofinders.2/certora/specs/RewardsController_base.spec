...
///////////////// Properties ///////////////////////
    ...
    rule userIndex_accrued() {
        ...
        //Get rewardData
        indexBefore, emissionPerSecondBefore, lastUpdateTimestampBefore, distributionEndBefore = getRewardsData(e, AToken, reward);
        uint104 userAccruedBefore = getRewardAccruedForUser(e, AToken, reward, e.msg.sender);
        ...
        uint104 userAccruedAfter = getRewardAccruedForUser(e, AToken, reward, e.msg.sender);
